...
% ConeLeft = imread('ConeLeft.png');
% ConeRight = imread('ConeRight.png');
% frameLeftGray = rgb2gray(ConeLeft);
% frameRightGray = rgb2gray(ConeRight); 

%%%%%%%%%%%------------------------End of Task 3--------------------------

%%%%%%%%%%%---------------------Task 4 Teddy Bears------------------------

% TeddyLeft = imread('TeddyLeft.png');
% TeddyRight = imread('TeddyRight.png');
% frameLeftGray = rgb2gray(TeddyLeft);
% frameRightGray = rgb2gray(TeddyRight); 
